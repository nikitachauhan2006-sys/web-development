...
declare const DescribeModelBiasJobDefinitionCommand_base: {
    new (input: DescribeModelBiasJobDefinitionCommandInput): import("@smithy/core/client").CommandImpl<DescribeModelBiasJobDefinitionCommandInput, DescribeModelBiasJobDefinitionCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeModelBiasJobDefinitionCommandInput): import("@smithy/core/client").CommandImpl<DescribeModelBiasJobDefinitionCommandInput, DescribeModelBiasJobDefinitionCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
