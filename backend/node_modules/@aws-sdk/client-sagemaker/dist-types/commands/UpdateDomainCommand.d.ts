...
declare const UpdateDomainCommand_base: {
    new (input: UpdateDomainCommandInput): import("@smithy/core/client").CommandImpl<UpdateDomainCommandInput, UpdateDomainCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateDomainCommandInput): import("@smithy/core/client").CommandImpl<UpdateDomainCommandInput, UpdateDomainCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
