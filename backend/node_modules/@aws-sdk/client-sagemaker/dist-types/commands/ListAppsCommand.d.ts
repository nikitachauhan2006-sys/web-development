...
declare const ListAppsCommand_base: {
    new (input: ListAppsCommandInput): import("@smithy/core/client").CommandImpl<ListAppsCommandInput, ListAppsCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListAppsCommandInput]): import("@smithy/core/client").CommandImpl<ListAppsCommandInput, ListAppsCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
