...
import type { CreateNotebookInstanceLifecycleConfigInput, CreateNotebookInstanceLifecycleConfigOutput } from "../models/models_2";
/**
 * @public
 */
...
declare const CreateNotebookInstanceLifecycleConfigCommand_base: {
    new (input: CreateNotebookInstanceLifecycleConfigCommandInput): import("@smithy/core/client").CommandImpl<CreateNotebookInstanceLifecycleConfigCommandInput, CreateNotebookInstanceLifecycleConfigCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateNotebookInstanceLifecycleConfigCommandInput): import("@smithy/core/client").CommandImpl<CreateNotebookInstanceLifecycleConfigCommandInput, CreateNotebookInstanceLifecycleConfigCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
