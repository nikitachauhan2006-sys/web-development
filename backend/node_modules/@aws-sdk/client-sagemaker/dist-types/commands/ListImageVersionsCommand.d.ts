...
declare const ListImageVersionsCommand_base: {
    new (input: ListImageVersionsCommandInput): import("@smithy/core/client").CommandImpl<ListImageVersionsCommandInput, ListImageVersionsCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListImageVersionsCommandInput): import("@smithy/core/client").CommandImpl<ListImageVersionsCommandInput, ListImageVersionsCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
