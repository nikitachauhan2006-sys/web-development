...
declare const DescribeSpaceCommand_base: {
    new (input: DescribeSpaceCommandInput): import("@smithy/core/client").CommandImpl<DescribeSpaceCommandInput, DescribeSpaceCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeSpaceCommandInput): import("@smithy/core/client").CommandImpl<DescribeSpaceCommandInput, DescribeSpaceCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
