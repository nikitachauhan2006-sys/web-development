...
declare const DescribeDomainCommand_base: {
    new (input: DescribeDomainCommandInput): import("@smithy/core/client").CommandImpl<DescribeDomainCommandInput, DescribeDomainCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeDomainCommandInput): import("@smithy/core/client").CommandImpl<DescribeDomainCommandInput, DescribeDomainCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
