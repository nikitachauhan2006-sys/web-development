...
declare const DescribeUserProfileCommand_base: {
    new (input: DescribeUserProfileCommandInput): import("@smithy/core/client").CommandImpl<DescribeUserProfileCommandInput, DescribeUserProfileCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeUserProfileCommandInput): import("@smithy/core/client").CommandImpl<DescribeUserProfileCommandInput, DescribeUserProfileCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
