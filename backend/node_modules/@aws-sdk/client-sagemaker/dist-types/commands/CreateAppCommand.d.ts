...
declare const CreateAppCommand_base: {
    new (input: CreateAppCommandInput): import("@smithy/core/client").CommandImpl<CreateAppCommandInput, CreateAppCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateAppCommandInput): import("@smithy/core/client").CommandImpl<CreateAppCommandInput, CreateAppCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
