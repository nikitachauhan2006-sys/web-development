...
declare const CreateDataQualityJobDefinitionCommand_base: {
    new (input: CreateDataQualityJobDefinitionCommandInput): import("@smithy/core/client").CommandImpl<CreateDataQualityJobDefinitionCommandInput, CreateDataQualityJobDefinitionCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateDataQualityJobDefinitionCommandInput): import("@smithy/core/client").CommandImpl<CreateDataQualityJobDefinitionCommandInput, CreateDataQualityJobDefinitionCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
