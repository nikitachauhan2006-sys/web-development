...
declare const DescribeAppCommand_base: {
    new (input: DescribeAppCommandInput): import("@smithy/core/client").CommandImpl<DescribeAppCommandInput, DescribeAppCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeAppCommandInput): import("@smithy/core/client").CommandImpl<DescribeAppCommandInput, DescribeAppCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
