...
declare const DescribeMonitoringScheduleCommand_base: {
    new (input: DescribeMonitoringScheduleCommandInput): import("@smithy/core/client").CommandImpl<DescribeMonitoringScheduleCommandInput, DescribeMonitoringScheduleCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeMonitoringScheduleCommandInput): import("@smithy/core/client").CommandImpl<DescribeMonitoringScheduleCommandInput, DescribeMonitoringScheduleCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
