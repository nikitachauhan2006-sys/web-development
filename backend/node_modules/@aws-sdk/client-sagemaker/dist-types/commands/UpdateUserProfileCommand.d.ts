...
declare const UpdateUserProfileCommand_base: {
    new (input: UpdateUserProfileCommandInput): import("@smithy/core/client").CommandImpl<UpdateUserProfileCommandInput, UpdateUserProfileCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateUserProfileCommandInput): import("@smithy/core/client").CommandImpl<UpdateUserProfileCommandInput, UpdateUserProfileCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
