...
declare const CreateModelQualityJobDefinitionCommand_base: {
    new (input: CreateModelQualityJobDefinitionCommandInput): import("@smithy/core/client").CommandImpl<CreateModelQualityJobDefinitionCommandInput, CreateModelQualityJobDefinitionCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateModelQualityJobDefinitionCommandInput): import("@smithy/core/client").CommandImpl<CreateModelQualityJobDefinitionCommandInput, CreateModelQualityJobDefinitionCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
