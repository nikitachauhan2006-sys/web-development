...
declare const CreateSpaceCommand_base: {
    new (input: CreateSpaceCommandInput): import("@smithy/core/client").CommandImpl<CreateSpaceCommandInput, CreateSpaceCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateSpaceCommandInput): import("@smithy/core/client").CommandImpl<CreateSpaceCommandInput, CreateSpaceCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
