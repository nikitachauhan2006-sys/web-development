...
declare const UpdateNotebookInstanceCommand_base: {
    new (input: UpdateNotebookInstanceCommandInput): import("@smithy/core/client").CommandImpl<UpdateNotebookInstanceCommandInput, UpdateNotebookInstanceCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateNotebookInstanceCommandInput): import("@smithy/core/client").CommandImpl<UpdateNotebookInstanceCommandInput, UpdateNotebookInstanceCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
