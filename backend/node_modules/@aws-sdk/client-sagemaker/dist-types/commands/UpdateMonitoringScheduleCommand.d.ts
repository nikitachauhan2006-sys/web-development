...
declare const UpdateMonitoringScheduleCommand_base: {
    new (input: UpdateMonitoringScheduleCommandInput): import("@smithy/core/client").CommandImpl<UpdateMonitoringScheduleCommandInput, UpdateMonitoringScheduleCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateMonitoringScheduleCommandInput): import("@smithy/core/client").CommandImpl<UpdateMonitoringScheduleCommandInput, UpdateMonitoringScheduleCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
