...
declare const CreateUserProfileCommand_base: {
    new (input: CreateUserProfileCommandInput): import("@smithy/core/client").CommandImpl<CreateUserProfileCommandInput, CreateUserProfileCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateUserProfileCommandInput): import("@smithy/core/client").CommandImpl<CreateUserProfileCommandInput, CreateUserProfileCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
