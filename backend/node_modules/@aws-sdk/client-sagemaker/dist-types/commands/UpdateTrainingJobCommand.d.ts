...
declare const UpdateTrainingJobCommand_base: {
    new (input: UpdateTrainingJobCommandInput): import("@smithy/core/client").CommandImpl<UpdateTrainingJobCommandInput, UpdateTrainingJobCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateTrainingJobCommandInput): import("@smithy/core/client").CommandImpl<UpdateTrainingJobCommandInput, UpdateTrainingJobCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
