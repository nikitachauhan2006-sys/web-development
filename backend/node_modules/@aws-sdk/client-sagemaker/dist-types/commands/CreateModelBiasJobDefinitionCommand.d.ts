...
declare const CreateModelBiasJobDefinitionCommand_base: {
    new (input: CreateModelBiasJobDefinitionCommandInput): import("@smithy/core/client").CommandImpl<CreateModelBiasJobDefinitionCommandInput, CreateModelBiasJobDefinitionCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateModelBiasJobDefinitionCommandInput): import("@smithy/core/client").CommandImpl<CreateModelBiasJobDefinitionCommandInput, CreateModelBiasJobDefinitionCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
