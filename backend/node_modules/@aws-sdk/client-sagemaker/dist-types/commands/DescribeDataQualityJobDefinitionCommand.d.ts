...
declare const DescribeDataQualityJobDefinitionCommand_base: {
    new (input: DescribeDataQualityJobDefinitionCommandInput): import("@smithy/core/client").CommandImpl<DescribeDataQualityJobDefinitionCommandInput, DescribeDataQualityJobDefinitionCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeDataQualityJobDefinitionCommandInput): import("@smithy/core/client").CommandImpl<DescribeDataQualityJobDefinitionCommandInput, DescribeDataQualityJobDefinitionCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
