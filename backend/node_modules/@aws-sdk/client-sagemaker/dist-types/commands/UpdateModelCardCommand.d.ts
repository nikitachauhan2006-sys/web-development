...
declare const UpdateModelCardCommand_base: {
    new (input: UpdateModelCardCommandInput): import("@smithy/core/client").CommandImpl<UpdateModelCardCommandInput, UpdateModelCardCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateModelCardCommandInput): import("@smithy/core/client").CommandImpl<UpdateModelCardCommandInput, UpdateModelCardCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
